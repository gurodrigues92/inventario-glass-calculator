...
const HeroSection = () => {
  return <div className="text-center mb-16 sm:mb-12 fade-in-up">
      ...
      <p className="subtitle-responsive max-w-2xl mx-auto leading-relaxed mb-4 sm:mb-3 text-center" style={{
      color: '#476D9E'
    }}>Descubra agora quanto você pode economizar com nosso cálculo inteligente</p>
      <p className="text-xl sm:text-2xl font-bold mb-8 sm:mb-6 text-center" style={{
      color: '#0C2C45',
      ...
      <div className="flex justify-center items-center gap-6 sm:gap-8 mb-10 sm:mb-8 flex-wrap">
      ...
      <div className="max-w-2xl mx-auto p-6 sm:p-4 rounded-lg mb-6 sm:mb-4" style={{
