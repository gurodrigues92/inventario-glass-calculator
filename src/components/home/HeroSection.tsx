...
const HeroSection = () => {
  return <div className="text-center mb-12 fade-in-up">
      <h1 className="title-responsive heading-responsive mb-6 sm:mb-8 max-w-4xl mx-auto text-center">
        Reduza Legalmente o Imposto de Herança e Proteja seu Patrimônio
      </h1>
      <p className="subtitle-responsive max-w-2xl mx-auto leading-relaxed mb-5 sm:mb-6 text-center" style={{
      color: '#476D9E'
    }}>Descubra agora quanto você pode economizar com nosso cálculo inteligente</p>
      <p className="text-xl sm:text-2xl font-bold mb-8 sm:mb-10 text-center" style={{
      color: '#0C2C45',
      ...
      <div className="flex justify-center items-center gap-4 sm:gap-6 mb-10 sm:mb-8 flex-wrap">
