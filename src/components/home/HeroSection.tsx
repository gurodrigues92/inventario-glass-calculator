...
const HeroSection = () => {
  return <div className="text-center mb-12 fade-in-up">
      ...
      <p className="subtitle-responsive max-w-2xl mx-auto leading-relaxed mb-3 text-center" style={{
      color: '#476D9E'
    }}>Descubra agora quanto você pode economizar com nosso cálculo inteligente</p>
      <p className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-center" style={{
      color: '#0C2C45',
      ...
      <div className="max-w-2xl mx-auto p-4 rounded-lg mb-8" style={{
